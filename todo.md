...
## Fix: ยอดรวมทุกหน้าให้ตรงกับหน้ารายรับ — แก้ populate cache (2026-05-10)
- [ ] วิเคราะห์ว่า total_amount ใน cache มาจากไหน (populateCache.ts)
- [ ] แก้ populateCache.ts ให้ total_amount = payment_transactions.amount โดยตรง
- [ ] แก้ frontend ทุกหน้าให้ใช้ total_amount (+ badDebt) เป็นยอดรวมแทน breakdown
- [ ] Re-populate cache ทั้ง BP และ FF365
- [ ] ตรวจสอบยอดรวมตรงกับหน้ารายรับ 308,797,982.57
- [ ] Commit, push GitHub และ save checkpoint
