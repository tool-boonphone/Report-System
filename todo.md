...
- [ ] P79-1: Pin 2 คอลัมน์ (เดือน + สัญญา) ด้านซ้ายตาราง
- [ ] P79-2: แถบ "จำนวนสัญญา" — ลบ badge ออกทั้งหมด
- [ ] P79-3: แถบ "ยอดชำระแล้ว" — badge: เงินต้น/ดอกเบี้ย/ค่าดำเนินการ/ค่าปรับ/ส่วนลด(ปิดเสมอ+ไม่รวม)/ชำระเกิน/รวมยอดชำระ; eye toggle มีผลต่อยอดในตาราง
- [ ] P79-4: แถบ "ยอดค้างชำระ" — badge: เงินต้น/ดอกเบี้ย/ค่าดำเนินการ/ค่าปรับ/รวมยอดค้างชำระ; eye toggle มีผลต่อยอดในตาราง
- [ ] P79-5: Column group hierarchy ในหัวตาราง พร้อม eye toggle ต่อ column (มีผลต่อการคำนวณทั้งหมด)
...
- [ ] P79-6: แยก bucket "หนี้เสีย" เป็น 2 คอลัมน์ในแถบยอดชำระแล้ว (ยอดชำระ / หนี้เสีย)
- [ ] P79-7: ตรวจสอบ TypeScript + commit + checkpoint
