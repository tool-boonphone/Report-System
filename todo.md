...
- [ ] P11-1: ตัวกรองข้อมูลสัญญา cascading interdependent — ตัวเลือกแต่ละตัวกรองตัดออกตามตัวกรองอื่น (สัมพันธ์กันทุกคอลัมน์)
- [ ] P11-2: การจัดการสิทธิ์ section — กลุ่มสิทธิ์สามารถกำหนดได้ว่าเข้าถึง Section ไหนได้บ้าง
- [ ] P11-3: Contextual row highlight (hover) ทุกตาราง — ผู้ใช้รู้ว่ากำลังจัดการแถวไหน
