...
## Phase 135 — แก้ไขคอลัมน์ยอดเก็บหนี้ในหน้าภาพรวม

- [x] แก้ไข DebtOverview.tsx: collectedPtTotal ไม่รวม p.badDebt (ยอดขายเครื่อง) เพื่อให้ยอดเก็บหนี้ไม่รวมยอดขายเครื่องที่แยกคอลัมน์อยู่แล้ว
