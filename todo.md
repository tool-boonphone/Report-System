...
- [x] Phase 139: สรุปรายเดือน — รวมสถานะ "ยกเลิกสัญญา" เข้าไปในตารางและ badge ด้วย (ปัจจุบันถูกกรองออก)
...
- [x] ดึง resume_page จาก last failed sync log สำหรับ contracts stage
